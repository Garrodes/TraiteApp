 ...
 */
final class Version20230429131802 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cow_health (cow_id INT NOT NULL, health_id INT NOT NULL, INDEX IDX_56901A17A08E947C (health_id), INDEX IDX_56901A174B28B8CC (cow_id), PRIMARY KEY(cow_id, health_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
